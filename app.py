...
st.markdown("""
    ...
    @media (max-width: 1000px) {
        ...
        /* 【8列レイアウト（カレンダー）】全ブラウザ対応の16% + 12%×7分割 */
    ...
    div[data-testid="column"]:first-child:nth-last-child(8) ~ div .stButton > button:hover:not(:disabled) {
